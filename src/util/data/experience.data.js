...
export const experiences = [
...

  {
    ...
    badges: [2, 3, 7, 5],
    description: `At Control System, I spearheaded the creation of a server-side rendering app that powers a robust GPS tracking 
    solution for vehicles via a web app. I architected the backend utilizing Node.js, Express, and MySQL, complemented by Google Maps 
    for accurate tracking. Leveraging Passport.js, I ensured secure authentication. On the frontend, I harnessed Handlebars, CSS, and 
    Bootstrap for a seamless interface. Outcome: Empowering users with real-time vehicle location insights.`
  },
